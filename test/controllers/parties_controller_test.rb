...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { Date: @party.Date, Location: @party.Location, Name: @party.Name, Password: @party.Password, Requirements: @party.Requirements, Token: @party.Token, URL: @party.URL }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { Date: @party.Date, Location: @party.Location, Name: @party.Name, Password: @party.Password, Requirements: @party.Requirements, Token: @party.Token, URL: @party.URL }
    assert_redirected_to party_path(assigns(:party))
  end
